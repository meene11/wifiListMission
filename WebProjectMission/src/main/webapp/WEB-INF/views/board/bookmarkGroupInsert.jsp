...
<div style="padding:5px;">
	...
	<form name="form" id="form1" action="/controller/bkmkGroupInsert" >
		<table>
			<tr>
				<th>북마크 이름</th>
				<td style="text-aling:left;"><input type="text" id="bookmarkNm" name="bookmarkNm" value=""></td>
			</tr>
			<tr>
				<th>순서</th>
				<td style="text-align:left;"><input type="text" id="orderTurn" name="orderTurn" value=""></td>
			</tr>
